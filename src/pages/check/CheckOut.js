     ...
     <div className='max-w-[446px] mx-auto w-full mb-[20px]'>
      <div className='flex max-w-[388px] w-full justify-between  xsm:mt-[0px] md:mt-[58px] mx-auto' >
        <div className='max-w-[194px] w-full flex items-center justify-center relative flex-col top-[20px]  '>
            <div onClick={()=>{setblue(1)}} className={`z-10 bg-[#ffffff] rounded-full w-[40px] h-[40px] border-[2.5px] border-solid  flex items-center justify-center border-[${blue==1?('#0156FF'):('#CACDD8')}] cursor-pointer`}><img src={Tick} alt="" /></div>
            <div className={`z-5 absolute  top-[20px]  max-w-[194px] w-full border-[1.5px] border-solid  border-[${blue==1?('#0156FF'):('#CACDD8')}] `} ></div>
            <p className={`text-[16px] font-[400] leading-[20px] pt-[6px] text-[${blue==1?('#000000'):('#CACDD8')}]`} >Shipping</p>
        </div>
        <div className='max-w-[194px] w-full flex items-center justify-center relative flex-col top-[20px]  '>
            <div onClick={()=>{setblue(2)}} className={`z-10 bg-[#ffffff] rounded-full w-[40px] h-[40px] border-[2.5px] border-solid border-[${blue==2?('#0156FF'):('#CACDD8')}] flex items-center justify-center cursor-pointer`}><p className='text-[15px] leading-[24px] font-[600]'>2</p></div>
            <div className={`z-5 absolute top-[20px]   max-w-[194px] w-full border-[1.5px] border-solid border-[${blue==2?('#0156FF'):('#CACDD8')}]`}></div>
            <p className={`text-[16px] font-[400] leading-[20px] pt-[6px] text-[${blue==2?('#000000'):('#CACDD8')}]`}>Review & Payments</p>
        </div>
      </div>
